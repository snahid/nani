<?php 
    ...
    <div class="baner-section-wrapper">
      <div class="container">
        <div class="dry-inner-wrapper">
          <div class="bottom-wrapper">
            <h1>Dry fruits and nuts</h1>
      ...
      <div class="product-range-wrapper">
        <div class="container">
          <div class="product-range">
            <h2 class="dry-range-title">Dry Fruits and Nuts Product Range</h2>
            <div class="product-range-inner">
              <div class="product-range-left">
                <ul>
                  <li>Cashew Nut Broken</li>
                  <li>Cashew Nut Whole</li>
                  <li>Raisin Golden</li>
                </ul>
              </div>
              <div class="product-range-left">
                <ul>
                  <li>Raisin Green (Chinese)</li>
                  <li>Raisins Munakka</li>
                  <li>Raisin Munakka Long</li>
                </ul>
              </div>
            </div>
          </div>

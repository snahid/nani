<?php $page='products';
$title='Delicacies :: Nani Agro Foods Pvt. Ltd.';
    ...
    <div class="baner-section-wrapper">
      <div class="container">
        <div class="delicacy-inner-wrapper">
          <div class="bottom-wrapper">
            <h1>Delicacies</h1>
            <div class="bottom-inner-wrapper">
              <div class="bottom-left">
                <p>
                  We understand how small bites can offer big satisfaction when
                  you are hungry. That is why we present a wide range of
                  delicacy products to our customers. Visit our store to find
                  products, like kurmura Basmati, kurmura Bhatti, mamra, mamra Basmati, poha medium, poha thick, etc.
                </p>
              </div>
              <div class="bottom-right">
                <a href="#delicacyenquire"><img src="./assets/images/delicacy-enquire-now.png" alt=""></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="product-range-wrapper">
      <div class="container">
        <div class="product-range">
          <h2 class="delicacy-range-title">Delicacy Product Range</h2>
          <div class="product-range-inner">
            <div class="product-range-left">
              <ul>
                <li>Kurmura Basmati</li>
                <li>Kurmura Bhatti</li>
                <li>Mamra (Puffed
                  Rice)</li>
              </ul>
            </div>
    ...
    <!-- Private Label  -->
     ...
     <!-- Enquire Now Wrapper  -->
     <div class="enquire-wrapper" id="delicacyenquire">
        <div class="container">

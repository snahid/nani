<?php $page='products';
$title='Grinders :: Nani Agro Foods Pvt. Ltd.';
    ...
    <div class="baner-section-wrapper">
      <div class="container">
        <div class="grinder-baner-inner-wrapper">
          <div class="bottom-wrapper">
            ...
            <div class="bottom-inner-wrapper">
              ...
              <div class="bottom-right">
                <a href="#grinderenquire"><img src="./assets/images/grinder-enquire-now.png" alt=""></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="process-wrapper">
      <div class="container">
        <div class="process-inner">
          <h3 class="process-title grinder-process-title">Grinders Process</h3>
      ...
      <div class="product-range-inner">
          <div class="product-range-left">
              <ul>
                  <li>Black Pepper</li>
                  <li>White Pepper</li>
                  <li>Pink Rock Salt</li>
              </ul>
          </div>
          <div class="product-range-left">
              <ul>
                  <li>Black Salt</li>
                  <li>Crystal Rock Salt</li>
...
<!-- Product Range  -->
    ...
    <!-- Enquire Now Wrapper  -->
    <div class="enquire-wrapper" id="grinderenquire">
        <div class="container">

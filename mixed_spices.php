<?php 
    ...
    <div class="baner-section-wrapper">
        <div class="container">
            <div class="mixed-whole-baner-inner-wrapper">
              <div class="bottom-wrapper">
                  <h1>Mixed Whole Spice</h1>
                  <div class="bottom-inner-wrapper">
                    ...
                    <div class="bottom-right">
                        <a href="#mixedenquire"><img src="./assets/images/mixed-spice-enquire-now.png" alt=""></a>
                    </div>
                  </div>
              </div>
            </div>
    ...
    <div class="process-wrapper">
        <div class="container">
            <div class="process-inner">
                <h3 class="process-title mixed-process-title">Mixed Whole Spice Process</h3>
     ...
     <div class="product-range-wrapper">
      <div class="container">
        <div class="product-range">
          <h2 class="range-title mixed-range-title">Mixed Whole Spice Product Range</h2>
          <div class="product-range-inner">
              <div class="product-range-left">
                  <ul>
                      <li>Garam Masala Whole</li>
                      <li>Biryani Masala Whole</li>
                  </ul>
              </div>
              <div class="product-range-left">
                  <ul>
                      <li>Curry Masala Whole</li>
                      <li>Mix Spices (Panchpuran)</li>
                  </ul>
              </div>
          </div>
        </div>
  ...
  <!-- Product Range  -->
    ...
    <!-- Enquire Now Wrapper  -->
    <div class="enquire-wrapper" id="mixedenquire">
        <div class="container">

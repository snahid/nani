<?php $page='products';
 $title = 'Spice Blends :: Nani Agro Foods Pvt. Ltd.';
    ...
    <div class="baner-section-wrapper">
        <div class="container">
            <div class="spice-blends-baner-inner-wrapper">
              <div class="bottom-wrapper">
                  ...
                  <div class="bottom-inner-wrapper">
                    ...
                    <div class="bottom-right">
                        <a href="#spicesenquire"><img src="./assets/images/spices-enquire-now.png" alt=""></a>
                    </div>
                  </div>
              </div>
            </div>
    ...
    <div class="process-wrapper">
        <div class="container">
            <div class="process-inner">
                <h3 class="process-title spice-process-title">Spice Blends Process</h3>
    ...
    <div class="product-range-wrapper">
        <div class="container">
          <div class="product-range">
            <h2 class="range-title spice-range-title">Spice Blends Product Range</h2>
            <div class="product-range-inner">
                <div class="product-range-left">
                    <ul>
                        <li>Hyderbadi Biryani Masala</li>                      
                        <li>Chana Masala</li>                      
                        <li>Chat Masala</li>                      
                        <li>Chicken Masala</li>                      
                        <li>Tandoori Chicken Masala</li>                      
                        <li>Curry Powder Hot</li>                      
                        <li>Curry Powder Mild</li>                      
                        <li>Curry Powder - Madras</li>                      
                        <li>Fish Masala</li>                      
                        <li>Garam Masala</li>                      
                        <li>Meat Masala</li>                      
                        <li>Pickle Masala</li>                      
                ...
                <div class="product-range-left">
                    <ul>
                        ...
                        <li>Kurma Masala</li>
                        <li>Shahi Paneer Masala</li>
                        <li>Butter Chicken Masala</li>
                        <li>Soya Chaap Masala</li>
                        <li> Tava Fry Masala</li>
                        <li>Rajma Masala</li>
                        <li>Egg Curry Masala</li>
                        <li>Pani Puri Masala</li>
                    </ul>
                </div>
                <div class="product-range-left">
                    <ul>
                        <li> Dal Makhani Masala</li>
                        <li>Kadai Paneer Masala</li>
                        <li>Achari Aloo Masala</li>
                        <li>Kanda Lasun Masala</li>
                        <li>Achar Gosht Masala</li>
                        <li>Duck Roast Masala</li>
                        <li>Gujarati Kadhi Masala</li>
                        <li>Dal Fry Masala</li>
                        <li>Puliogare Masala</li>
                        <li>Poha Masala</li>
                        <li>Rogan Josh Masala</li>
                    </ul>
                </div>
            </div>
          </div>
    ...
    <!-- Enquire Now Wrapper  -->
    <div class="enquire-wrapper" id="spicesenquire">
        <div class="container">

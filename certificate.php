<?php $page='policies';
$title='Certificates :: Nani Agro Foods Pvt. Ltd.';
    ...
    <div class="baner-section-wrapper">
      <div class="container">
        <div class="certificate-baner-inner-wrapper">
          <div class="bottom-wrapper">
            ...
            <div class="bottom-inner-wrapper">
              ...
              <div class="bottom-right">
                <a href="javascript:void(0)" data-toggle="modal" data-target="#aboutModalCenter"><img src="./assets/images/certificate-enquire-now.png" alt=""></a>
              </div>
            </div>
          </div>
        </div>

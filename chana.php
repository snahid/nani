    ...
    <div class="product-range-wrapper">
      <div class="container">
        <div class="product-range">
          <h2 class="chana-range-title">Chana Product Range</h2>
          <div class="product-range-inner">
              <div class="product-range-left">
                  <ul>
                      <li>Roasted Salted Chana</li>
                      <li>Roasted UnSalted Chana</li>
                      <li>Roasted Daria Split</li>
                  </ul>
              </div>  
              <div class="product-range-left">
                <ul>
                    <li>Roasted Chana Large Mahabaleshwar</li>
                    <li>Roasted Daria Gota Mahabaleshwar</li>
                    <li>Daria Gota Small</li>
                </ul>
            </div>           
          </div>
        </div>
